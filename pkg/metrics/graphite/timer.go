...
func NewCustomTimer(meta *metrics.MetricMeta, h Histogram, m Meter) Timer {
	if UseNilMetrics {
		return NilTimer{}
	}
...
func RegTimer(name string, tagStrings ...string) Timer {
	tr := NewTimer(metrics.NewMetricMeta(name, tagStrings))
...
// Snapshot is a no-op.
func (n NilTimer) Snapshot() metrics.Metric { return n }
...
func (t *StandardTimer) Snapshot() metrics.Metric {
	t.mutex.Lock()
...
func (t *TimerSnapshot) Snapshot() metrics.Metric { return t }
