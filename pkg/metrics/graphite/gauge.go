...
func (g GaugeSnapshot) Snapshot() metrics.Metric { return g }
...
type NilGauge struct{ *metrics.MetricMeta }

// Snapshot is a no-op.
func (NilGauge) Snapshot() metrics.Metric { return NilGauge{} }
...
func (g *StandardGauge) Snapshot() metrics.Metric {
