...
type MetricClient interface {
	RegCounter(*metrics.MetricMeta) Counter
	RegTimer(*metrics.MetricMeta) Timer
	RegGauge(*metrics.MetricMeta) Gauge
}

func readSettings(settingsFile *ini.File) *MetricSettings {
